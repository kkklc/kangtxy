...
<div style="width:50%;margin:0 auto;height:auto;">
	...
	<p>&lt;Context docBase="kangtxy" path="/kangtxy" reloadable="true" source="org.eclipse.jst.j2ee.server:kangtxy"/&gt;</p>
	<p>path可以指定上下文 </p>
	<p>然后执行bin目录下的exe文件这是启动tomcat的意思，看到server startup in xxxms说明启动成功了</p>
	<div align="left">
